...
#'
#' @description This class converts the  result of a simulation call
#' into a SimulationResult instance
#'
#' @param resultJSON the output of a simulation call most likely
...
new_SimulationResult <- function(resultJSON) {
  ...
  } else if (startsWith(resultJSON$growthModel, "OSM")) { # OSM output
